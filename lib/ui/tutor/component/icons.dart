...
class TabIconData {
  ...
  static List<TabIconData> tabIconsList = <TabIconData>[
    ...
    TabIconData(
      imagePath: 'assets/bottom_bar/tab_2.png',
      selectedImagePath: 'assets/bottom_bar/tab_2s.png',
      index: 1,
      isSelected: false,
      animationController: null,
    ),
    TabIconData(
      imagePath: 'assets/bottom_bar/tab_3.png',
      selectedImagePath: 'assets/bottom_bar/tab_3s.png',
      index: 2,
      isSelected: false,
      animationController: null,
    ),
