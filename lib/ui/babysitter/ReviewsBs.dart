...
class reviewsScreenBsS extends StatefulWidget {
  final int userId;
  final int babysitterId;

  const reviewsScreenBsS({
    Key? key,
...
class _PerfilScreenState extends State<reviewsScreenBsS> {
          ...
          body: BlocConsumer<ReviewCubit, ReviewState>(
            ...
            builder: (context, state) {
              return ListView(
                ...
                children: [
                  Center(
                    child: Text('Reseñas y calificacion:',
                        style: TextStyle(
                            fontSize: 20,
                  ...
                  SizedBox(height: 20),
                  Text(
                    'Reseñas que han dejado los padres:',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 17,
                      fontWeight: FontWeight.bold,
